...
axios.get("http://api.bryanuniversity.edu/bobbythomas/list")
    .then(res => {
...
document.querySelector("#toDoForm").addEventListener("submit", (e) => {
    e.preventDefault();
    axios.post("http://api.bryanuniversity.edu/bobbythomas/list", {
    ...
    boxes.forEach((e, i) => {
        boxes[i].addEventListener("change", function() {
            if (boxes[i].checked == true) {
                ...
                axios.put(`http://api.bryanuniversity.edu/bobbythomas/list/${idArr[i]}`, {
                    isComplete: true
                })
                    .catch(err => console.log(err))
            }
...
document.addEventListener("mouseover", () => {
    ...
    delBtn.forEach((e, i) => {
        delBtn[i].addEventListener("click", () => {
            axios.delete(`http://api.bryanuniversity.edu/bobbythomas/list/${idArr[i]}`)
                .catch(err => console.log(err))
